            ...
            <div className="upper">
                ...
                <div className="headline4">
                    ...
                    <ul className="banking">
                        <li><img src={CheckMark} />Banking transactions are free for you</li>
                        <li><img src={CheckMark} />No monthly cash commission</li>
                        <li><img src={CheckMark} />Manage payments and transactions online</li>
