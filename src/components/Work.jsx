      ...
      <div className="container">
        ...
        <div className="mobile-first">
          ...
          <div className="headline-mobile">
            <h3>
              Transfers to people from <br /> your contact list
            </h3>
            <p>
        ...
        <div className="tablet-first">
          ...
          <div className="headline-tablet">
            <h3>
              Step 3. Transfers to people from your <br /> contact list
            </h3>
            <p>
              Proin volutpat mollis egestas. Nam luctus facilisis ultrices.{" "}
              <br /> Pellentesque volutpat ligula est. Mattis fermentum, at nec{" "}
              <br /> lacus.
            </p>
          </div>
        </div>
        ...
        <div className="desktop-first">
          ...
          <div className="headline-desktop">
            ...
            <p>
              ...
              Arcu sociis tristique <br /> quisque hac in consectetur
              condimentum.
            </p>
          </div>
        </div>
